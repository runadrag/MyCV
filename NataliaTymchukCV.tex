...
%\hspace{-2mm}	
   ...
   \textsc{Address:}   & \hspace{-2mm}Via G. Buffi 13, \\
   						& \hspace{-2mm}6904, Lugano, Switzerland \\
    \textsc{email:}     & \hspace{-2mm}\href{mailto:natalia.tymchuk@usi.ch}{natalia.tymchuk@usi.ch}\\
	\textsc{website:}     & \hspace{-2mm}\href{http://natalia.tymch.uk}{http://natalia.tymch.uk}

\end{tabular}
\end{adjustwidth}
\end{minipage}%
\begin{minipage}{4cm}
  \vspace{15mm}\hspace{9mm}\includegraphics[width=3.5cm]{photo1}
\end{minipage}
...
%		\textbf{Personal}			& \textbf{Information}	& \raisebox{-\totalheight}{\includegraphics[width=0.2\textwidth, height=35mm]{photoCV.png}} 
%\\ 
...
\begin{adjustwidth}{-2mm}{}
 ...
 & \small Advisor: Prof. Dr. Michele \textsc{Lanza}\\
\\
...
&\footnotesize{You can read more here:  \href{http://natalia.tymch.uk/RTVoronyjDiagram/}{natalia.tymch.uk/RTVoronyjDiagram/} }\\
...
&\footnotesize{ You can read more about this project here: \href{http://gsoc2013.esug.org/projects/scismalltalk}{gsoc2013.esug.org/projects/scismalltalk}  or you can read more about what I did on my blog: \href{http://blog.natalia.tymch.uk}{blog.natalia.tymch.uk}.}\\\multicolumn{2}{c}{} \\
...
\begin{adjustwidth}{-2mm}{}
\begin{tabular}{p{2cm} p{11cm}}
\textsc{2013} & {\href{https://www.coursera.org/course/interactivepython1}{\textbf{An Introduction to Interactive Programming in Python}}}\\
  &Coursera ­ Rice University. \footnotesize{ \href{http://natalia.tymch.uk/CourseraInteractivepython.pdf}{Completion Score: 96.4/100}}\\
    \\
 \textsc{2012} & {\href{https://www.coursera.org/course/programming1}{ \textbf {Learn to Program: The Fundamentals}}} \\ 
 &Coursera ­ University of Toronto. \footnotesize{\href{http://natalia.tymch.uk/CourseraProgramming.pdf}{Completion Score: 98,2/100}}\\
\end{tabular}
\end{adjustwidth}
...
\textsc{German:}&Basic\\
\textsc{Italian:}&Basic\\
\textsc{Russian:} &Upper Intermediate\\
\end{tabular}
\end{adjustwidth}
